...
EOS;
		...
		$this->assertEqual('support@rightsignature.com', $document->recipients[0]->email);
		$this->assertEqual('Document emailed to John Bellingham (john.b@rightsignature.com)', $document->audit_trail[0]->message);
	}
}
